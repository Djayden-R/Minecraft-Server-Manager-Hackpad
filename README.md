...
Couldn't I just make a Discord bot to ping me when my friends go online? Yeah, but it wouldn't be as fun as making a special device for on my desk that shows the Minecraft chat live.
...
The Hackpad will only send its button presses (either LONG or SHORT):
